...
class Reservation(models.Model):
    ...
    reservation_date = models.DateTimeField("予約日", auto_now_add=False, blank=True, null=True)
    reservation_time = models.TimeField("時刻", auto_now_add=False, default='18:00', blank=True, null=True)
...
class Review(models.Model):
    ...
    visited_at = models.DateField("利用日", auto_now_add=False, blank=True, null=True)
    created_at = models.DateTimeField("登録日", auto_now_add=True)
    updated_at = models.DateTimeField("更新日", auto_now_add=True)    
    deleted_at = models.DateTimeField("削除日", auto_now_add=True)
